                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="margin-top: 20px;">
                    <div class="card">
                        <div class="header bg-red">
                            <h2>
                                {{$cus->firstName}} {{$cus->lastName}} {{--  <small>Description text here...</small>  --}}
                            </h2>
                            <ul class="header-dropdown m-r-0">
                                <li>
                                    <a href="{{ url('/getCustomerDetail') }}/{{$cus->id}}" title="View Customer Details" ><i class="material-icons">remove_red_eye</i></a>
                                </li>
                            </ul>
                            
                        </div>
                        <div class="body">
                            <i class="material-icons">phone_android</i><b> Mobile:</b> {{$cus->contactNo}} <br>
                            <i class="material-icons">email</i><b> Email:</b> {{$cus->email}}<br>
                            <i class="material-icons">location_city</i><b> Address:</b> {{$cus->address}} 
                        </div>
                    </div>
                </div>
            @endforeach  
