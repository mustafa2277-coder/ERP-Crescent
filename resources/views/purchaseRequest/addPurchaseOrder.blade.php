        ...
        <section class="content">
                ...
                <div class="body">
                        <ol class="breadcrumb breadcrumb-bg-red">
                            ...
                            <li><a href="{{url('/getRequestPurchase')}}">Purchase Request</a></li>
                            <li class="active"><a>Edit Purchase Request</a></li>
                        </ol>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12" id="div_project">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text"  name="pdate" id="pdate" tabindex="3" class="form-control date" value="{{date("d-m-Y",strtotime($purchaseorders[0]->rpDate))}}">
                                ...
                                <input type="hidden" class="form-control" id="id" name="id" value="{{$purchaseorders[0]->rpId}}">
    ...
    @else
        <section class="content">
                ...
                <div class="body">
                        <ol class="breadcrumb breadcrumb-bg-red">
                            <li><a href="{{url('/home')}}">Home</a></li>
                            <li><a href="{{url('/getRequestPurchase')}}">Purchase Requests</a></li>
                            <li class="active"><a>New Purchase Request</a></li>
                        </ol>
                </div>
...
<!--     <script src="{{asset('public/js/pages/tables/jquery-datatable.js')}}"></script> -->
    ...
    <script src="{{asset('public/Rpurchase.js')}}"></script>
    ...
    <script type="text/javascript">
        ...
        row = "<tr><td> <select  id='product"+ndata+"' name='product["+ndata+"]' class='form-control show-tick' data-live-search='true'  required>"
                                   +selectOpt+
                                    "</select></td><td><input type='number' data-id='"+ndata+"' name='quantity["+ndata+"]' id='quantity"+ndata+"' class='form-control quantity' value='0' ></td><td style='text-align:center'><a id='icon-toggle-delete2' class='removebutton'>  <span class='glyphicon glyphicon-trash' aria-hidden='true'></span> </a></td></tr>";
