    ...
    <section class="content">
            <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-red">
                        ...
                        <li class="active"><a>Purchase Requests</a></li>
                    </ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            <div class="header">
                                ...
                                <h2>
                                     Purchase Requests
                            <a class="btn btn-primary btn-circle waves-effect waves-circle waves-float" id="add_new" href="{{ url('/getAddRequestPurchase')}}" accesskey="+"  style="float:right;"> 
                        ...
                        <div class="body">
                            ...
                            <form id="form_filter" name = "form" method="GET" action="{{ url('/getFilterRequestPurchase') }}">
