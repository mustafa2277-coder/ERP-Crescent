                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                    <div class="card">
                        <div class="header">
                            <h2>
                               Product Package
                                <a class="btn btn-primary btn-circle waves-effect waves-circle waves-float" style="margin-bottom: 14px;float:right;" id="add_new" accesskey="+" href="{{ url('/getAddProductPackage')}}"> 
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                @foreach($packages as $package)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/getEditProductPackage') }}/{{$package->id}}" ><i class="material-icons">edit</i></a>
                                        </td>
                                    </tr>
                                @endforeach  
                                </tbody>
