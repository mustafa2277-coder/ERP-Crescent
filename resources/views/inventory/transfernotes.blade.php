...
<section class="content">
            <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-red">
                        ...
                        <li class="active"><a>Transfer Notes</a></li>
                    </ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                    <div class="card">
                        ...
                        <?php   $i=1;  ?>
                            ...
                            <table  id="listOfNotes" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                <thead>
