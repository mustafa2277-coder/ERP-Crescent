...
<section class="content">
            <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-red">
                        ...
                        <li class="active"><a>Product Sales</a></li>
                    </ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                                <form id="form_filter" name = "form" method="POST" action="{{ url('/productSaleReport') }}">
                                    <div class="row clearfix">
                                     ...
                                     {{ csrf_field() }}    
                                        <div class="col-sm-12"  >
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" class="form-control" name="product" placeholder="Search Products..." tabindex='1' required>
                                        ...
                                        <div class="col-md-4" id="div_start_date">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                <input type="text" id="start_date" name="start_date" class="form-control" placeholder="Start date (dd/mm/yyyy)" tabindex='2' required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4" id="div_end_date">
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                <input type="text" id="end_date" name="end_date" class="form-control" placeholder="End date (dd/mm/yyyy)" tabindex='3' required>
                                        ...
                                        <div class="col-sm-4 " >
                                            ...
                                            <select  id="warehouse" name="warehouse" class="form-control show-tick" data-live-search="true" tabindex='4' required>
                                        ...
                                        {{-- <div class="col-md-4" id="div_vendor">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select id="filter_vendor" name="filter_vendor" class="form-control show-tick" data-live-search="true" tabindex='5'>
                        ...
                        <?php   $i=1;  ?>
                            ...
                            <table  id="listOfGrn" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        <a href="{{ url('/getEditGrn') }}/{{$grn->id}}" ><i class="material-icons">edit</i></a>
                                    </td> --}}
...
@section('js')
    ...
    //                         //      var aItem = { id: item.id, code: item.code, name: item.name+" ___RS "+item.salePrice};
    //                         //      return aItem;
    //                         //  });
    //                          var resultList = result.map(function (item) {
    //                              var aItem = { id: item.id, name: item.code+' '+item.name+" ___RS "+item.salePrice };
    //                              return aItem;
    //                          });
