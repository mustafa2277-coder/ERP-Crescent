                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <form id="form_filter" name = "form" method="GET" action="{{ url('/getFilterDateSales') }}">
                                <div class="row clearfix">
                                
                                 {{ csrf_field() }}    
                             
                                    <div class="col-md-6" id="div_start_date">
                                    ...
                                    <div class="col-md-6" id="div_end_date">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="material-icons">date_range</i>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-float">
                                            ...
                                            <b>Return Sale: </b> -{{$returnSales[0]->total}}
                                            <br>
                                            @if(isset($total))
                                                <b>Todays Token Sale: </b> {{$total}}
                                            @endif
                                       </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-striped table-hover" id="product_table">
                                ...
                                @foreach($sales as $sale)
                                    <tr>
                                        ...
                                        <td>{{$sale->empName}}</td>
                                        <td>
                                            <a href="#" class="printInvoice" data-id="{{$sale->id}}" title="Invoice" ><i class="material-icons">print</i></a>
                                            ...
                                            <a href="{{ url('/printA4Word')}}/{{$sale->id}}" class="printA4" data-id="{{$sale->id}}" title="Word Document" target="_blank" ><i class="material-icons">file_download</i></a>
                                        </td>
                                       {{--  <td> {{$product->id}}</td> --}}
                                    </tr>
                                @endforeach
                                ...
                                @endif
                                    @if($returnSales[0]->total)
                                    <tr>
                                        <td><b>Return Sale</b></td>
                                        <td></td>
                                        <td></td>
                                        <td>-{{$returnSales[0]->total}}</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan='4'> <span style="float:right;"id ='totalAmount'></span> </td>
...
@section('js')
    ...
    <script>
        ...
        //         $('#obj').val(JSON.stringify(data));
        //         $('#checkout').attr('action',"{{ url('/printA4')}}");
        //         //$('#inv'+id).remove();
