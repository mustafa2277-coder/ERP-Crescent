    ...
    <section class="content">
            <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-red">
                        ...
                        <li><a href="{{url('/employeeAllowanceList')}}">Employee Allowance List</a></li>
                        <li class="active">                
                                @if(isset($employeesAllowance))
                                    <a>Edit Employee Allowance</a>
                                @else
                                    <a>Add Employee Allowance</a>
                                @endif
                        </li>
                    </ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                    <div class="card">
                        ...
                        <div class="body">
                            {{--  Edit Form  --}}
                            @if(isset($employeesAllowance))
                            <form id="form_validation" action = "{{ url('/editEmployeeAllowance') }}" method = "POST">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{$employeesAllowance->id}}">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select  id="employee" name="employee" class="form-control show-tick" required>
                                            ...
                                            @foreach ($employee as $employee)    
                                                <option value="{{$employee->id}}" {{ $employee->id == $employeesAllowance->empId ? "selected":"" }}>{{$employee->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="col-sm-12">
                                        ...
                                        <select  id="alwnc" name="alwnc" class="form-control show-tick" required>
                                            <option value="0" selected="selected" disabled="disabled">Select Allowance</option>
                                            @foreach ($alwncs as $alwnc)    
                                                <option value="{{$alwnc->id}}" {{ $alwnc->id == $employeesAllowance->alwncId ? "selected":"" }}>{{$alwnc->alwnc}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" id="amount" name="amount" class="amount form-control" placeholder="" value="{{$employeesAllowance->amount}}" required>
                                </div>
                                <div class="col-sm-12">
                                    <label class="form-label">Date*</label>
                                    <input type="text" name="aDate" id="aDate" class="aDate form-control" placeholder="dd/mm/yyyy" value="{{date("d-m-Y",strtotime($employeesAllowance->aDate))}}" required>
                                </div>
                            ...
                            @else
                            {{--  ADD Form  --}}
                            <form id="form_validation" action = "{{ url('/addEmployeeAllowance') }}" method = "POST">
                                {{ csrf_field() }}
                                <div class="form-group form-float">
                                    <div class="col-sm-12">
                                        <label class="form-label">Employee Name*</label>
                                ...
                                <div class="form-group form-float">
                                    <div class="col-sm-12">
                                        ...
                                        <select  id="alwnc" name="alwnc" class="form-control show-tick" required>
                                            <option value="0" selected="selected" disabled="disabled">Select Allowance</option>
                                            @foreach ($alwncs as $alwnc)    
                                                <option value="{{$alwnc->id}}">{{$alwnc->alwnc}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <label class="form-label">Date*</label>
                                    <input type="text" name="aDate" id="aDate" class="aDate form-control" placeholder="dd/mm/yyyy" value="" required>
                                </div>
