    ...
    <section class="content">
            <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-red">
                        ...
                        <li><a href="{{url('/employeeDeductionList')}}">Employee Deduction List</a></li>
                        <li class="active">                
                                @if(isset($employeesDeduction))
                                    <a>Edit Employee Deduction</a>
                                @else
                                    <a>Add Employee Deduction</a>
                                @endif
                        </li>
                    </ol>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                    <div class="card">
                        ...
                        <div class="body">
                            {{--  Edit Form  --}}
                            @if(isset($employeesDeduction))
                            <form id="form_validation" action = "{{ url('/editEmployeeDeduction') }}" method = "POST">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{$employeesDeduction->id}}">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select  id="employee" name="employee" class="form-control show-tick" required>
                                            ...
                                            @foreach ($employee as $employee)    
                                                <option value="{{$employee->id}}" {{ $employee->id == $employeesDeduction->empId ? "selected":"" }}>{{$employee->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="col-sm-12">
                                        ...
                                        <select  id="deduct" name="deduct" class="form-control show-tick" required>
                                            <option value="0" selected="selected" disabled="disabled">Select Allowance</option>
                                            @foreach ($deduct as $deduct)    
                                                <option value="{{$deduct->id}}" {{ $deduct->id == $employeesDeduction->deductId ? "selected":"" }}>{{$deduct->deduct}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" id="dDate" name="dDate" class="dDate form-control" placeholder="" value="{{date("d-m-Y",strtotime($employeesDeduction->dDate))}}" required>
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label">Amount*</label>
                                    <input type="text" id="amount" name="amount" class="amount form-control" placeholder="" value="{{$employeesDeduction->amount}}" required>
                                </div>
                            ...
                            @else
                            {{--  ADD Form  --}}
                            <form id="form_validation" action = "{{ url('/addEmployeeDeduction') }}" method = "POST">
                                {{ csrf_field() }}
                                <div class="form-group form-float">
                                    <div class="col-sm-12">
                                        <label class="form-label">Employee Name*</label>
                                ...
                                <div class="form-group form-float">
                                    <div class="col-sm-12">
                                        <label class="form-label">Deduction Name*</label>
                                        <select  id="deduct" name="deduct" class="form-control show-tick" required>
                                            <option value="0" selected="selected" disabled="disabled">Select Deduction</option>
                                            @foreach ($deduct as $deduct)    
                                                <option value="{{$deduct->id}}">{{$deduct->deduct}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <label class="form-label">Date*</label>
                                    <input type="text" id="dDate" name="dDate" class="dDate form-control" placeholder="" value="" required>
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label">Amount*</label>
...
@section('js')
    ...
    $('#dDate').bootstrapMaterialDatePicker({  weekStart : 0, time: false ,format : 'DD/MM/YYYY'});
