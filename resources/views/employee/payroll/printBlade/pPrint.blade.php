...
<html lang="en">
    ...
    <body >
            ...
            <div style="float:right;">
                    ...
                    <strong>Month: </strong>{{$payrollMonth->month}}-{{$payrollMonth->year}}
                    <br>
            ...
            <table id="example"  class="table  table-striped table-hover">
                    <thead>
                        <tr style="background: #f44336;color: #fff;">
                            ...
                            <th style="text-align:center">Amount</th>
                            <th style="text-align:center">Gross Amount Payable</th>
                    ...
                    <tbody>
                        ...
                        @foreach($payrolls as $payroll)
                                    <tr>
                                        ...
                                        <td>{{$payroll->sundays+$payroll->normalDays}}</td>
                                        <td>{{$payroll->daysAmount}}</td>
                                        <td>{{$payroll->overtime}}</td>
                                        <td>{{$payroll->overtimeAmount}}</td>
                                        <td>{{$payroll->grossSalary}}</td>
                                        <td>{{$payroll->alwncAmount}}</td>
                            ...
                            <?php 
                              ...
                              $gross=$net+$payroll->grossSalary;
                            ?>
                        @endforeach  
                    
                    </tbody>
                    <tfoot style="text-align:center">
                         <th colspan="11">Total (Rs.)</th>
