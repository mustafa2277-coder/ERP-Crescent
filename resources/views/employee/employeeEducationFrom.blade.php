    ...
    <section class="content">
            <div class="body">
                    <ol class="breadcrumb breadcrumb-bg-red">
                        ...
                        <li><a href="{{url('/employeeList')}}?data=edu">Employee List</a></li>
                        <li class="active">                
                                @if(isset($employees))
                                    <a>Edit Employee Education</a>
                                @else
                                    <a>Add Employee Education</a>
                                @endif
                        </li>
                    </ol>
            </div>
                            ...
                            <form id="form_validation" action = "#" method = "POST">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                        <input type="text" class="form-control" id="education" name="education" value="" placeholder="Degree Title" required>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                        <input type="text" class="form-control" id="institute" name="institute" value="" placeholder="Institute" required>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <label>Degree Finishing Date*</label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                        <i class="material-icons">date_range</i>
                                        </span>
                                        <div class="form-line">
                                        <input type="date" class="form-control" id="finishing_date" name="finishing_date" value="" placeholder="" required>
                                        </div>
    ...
    $('#end').bootstrapMaterialDatePicker({  weekStart : 0, time: false ,format : 'DD/MM/YYYY'});
     ...
     $(document).ready(function() {
            ...
            $('#add').click(function(){
                ...
                finishing_date=$("#finishing_date").val(); 
                if(title==""){
                    swal('Fill Degree Title');
                    exit();
                }
                if(institute==""){
                    swal('Fill Institue');
            ...
            $("#jsGrid").jsGrid({
               ...
               // deleteConfirm: "Do you really want to delete the client?",
                ...
                fields: [
                    ...
                    { name: "Degree", type: "text", width: 100,editing: true },
                    { name: "Institute", type: "text", width: 100,editing: true },
                    { name: "EndDate", type: "text",width: 30,editing: true},
