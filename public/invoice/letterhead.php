...
<div id="thestyle">
    ...
    <div class="wrapper" id="slip1">
        ...
        <!-- <div><img height="100" width="100" src="http://admin.findurmeal.com/Temp/<?php echo $_GET['logo']; ?>"></div> -->
        <h2><strong  id='invoiceName' >Kashmir Homeopethic Store</strong></h2>
        <b id='invoiceAddress'>Sadique trade center Lahore</b>
        <div style="clear:both;"></div>
        <span id='invoiceNum' class="center"><b>Tel # 03000000000</b></span><br><br>
        <div style="clear:both;"></div>
       
        <table>
            <tr>
                <span class="left1">Customer :    <?php echo $_GET['customerDetail']['firstName']." ".$_GET['customerDetail']['lastName']; ?></span>
                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
                <span class="left1">Invoice No. : <?php echo $_GET['invoiceNo']; ?></span>
              &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                <span class="left1">Contact #. : <?php echo $_GET['customerDetail']['mobNo']; ?></span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span class="left1">Date :<?php echo date("Y-m-d "); ?></span>
        ...
        <table class="table" cellspacing="0" border="0">
            <thead>
                <tr>
                    <th><em>#</em></th>
                    <th class = 'bigfonts'>Items</th>
                    <th class = 'bigfonts'>Quantity</th>
                    <th class = 'bigfonts'>Subtotal</th>
                </tr>
            </thead>
            <tbody>
                ...
                $count = 1;
                $quantity = 0;
                $discount = $_GET['discountAmount'];
                $sub_total = $_GET['subTotal'];
                $total = $_GET['totalAmount'];
                $paid =  $_GET['paid'];
                $change = $_GET['change'];
                $previousBalance = $_GET['previousBalance'];
                $receivable = $_GET['receivable'];
                
                foreach ($_GET['orderDetail'] as $value) {
                    // echo  "\n"."after loop"."\n";
                    // var_dump($value);exit();
                    $quantity = $quantity + 1;
                    $amount = $value['quantity']*$value['unitPrice'];
                    echo "<tr><td class = 'bigfonts' style='text-align:center; width:30px;'>$count</td>
                    <td class = 'bigfonts' style='text-align:left; width:180px;'>$value[name]</td>
                    <td class = 'bigfonts' style='text-align:center; width:50px;'>$value[quantity]</td>
                    <td class = 'bigfonts' style='text-align:right; width:70px; '>$amount</td></tr>";
                    $count++;
                } 
                ?>
        ...
        <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px;">
            <tbody>
                <tr>
                    <td style="text-align:left; font-size: 12px;">Total Items</td><td style="text-align:right; padding-right:1.5%;font-size: 12px; border-right: 1px solid #000"><?php echo $quantity; ?></td>
                    <td style="text-align:left; padding-left:1.5%;font-size: 12px;">Sub Total</td><td style="text-align:right;font-size: 12px;"><?php echo $sub_total; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align:left; border-top:1px solid #000; padding-top:5px;font-size: 12px;">Discount</td><td colspan="2" id="tax" style="border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;"><?php echo $discount; ?></td>
                </tr>
                 
               <tr><td colspan='2' style='text-align:left; border-top:1px solid #000; padding-top:5px;font-size: 12px;'>Previous Balance</td><td colspan='2' id='previous_bal' style='border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;'><?php echo $previousBalance; ?></td>
                </tr>
                <tr><td colspan='2' style='text-align:left; padding-top:5px;font-size: 12px;'>Receivable</td><td colspan='2' id='receivable_bal' style=' padding-top:5px; text-align:right;font-size: 12px;'><?php echo $receivable; ?></td>
                </tr> 
                <tr>
                    <td colspan="2" style="text-align:left;border-top:1px solid #000;  padding-top:5px;font-size: 12px;">Grand Total</td><td colspan="2" id="grand_total" style="border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;"><?php echo $total + $previousBalance - $receivable; ?></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align:left; padding-top:5px;font-size: 12px;">Paid</td><td colspan="2" style="padding-top:5px; text-align:right;font-size: 12px;"><?php echo $paid; ?></td>
                </tr>
                <tr><td colspan="2" style="text-align:left; padding-top:5px;font-size: 12px;">Change</td><td colspan="2" style="padding-top:5px; text-align:right;font-size: 12px;"><?php echo $change; ?></td>
                </tr>
            </tbody>
        </table>
        <div style="border-top:1px solid #000; padding-top:10px;">
            <!--  <h2>Token No : <?php echo $_GET['token'];?></h2> -->
            <p>
                Thank you !<br>
                <p>For Any Suggestions And Complaints Contact Us At 0300-000000</p>
            </p> </div>
           ...
           <div id="buttons" style="padding-top:10px; text-transform:uppercase;">
                ...
                <span class="right"><button type="button" onclick="printHTML();" style="width:100%; cursor:pointer; font-size:12px; background-color:#007fff; color:#fff; text-align: center; border:1px solid #007fff; padding: 10px 1px;">Print</button></span>
                <div style="clear:both;"></div>
            </div>
