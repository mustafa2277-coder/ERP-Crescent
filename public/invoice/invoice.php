...
<div id="thestyle">
    ...
    <div class="wrapper" id="slip1">
        ...
        <div style="clear:both;"></div>
            <span class="left1">Customer :    <?php echo $obj[0][0]['firstName'].' '.$obj[0][0]['lastName'];?></span>
            <div style="clear:both;"></div>
            <span class="left1">Invoice No. : <?php echo $obj[0][0]['id']; ?></span>
            <div style="clear:both;"></div>
            <span class="left1">Contact #. : <?php echo $obj[0][0]['contactNo']; ?></span>
            <div style="clear:both;"></div>
            <span class="left1">Date :<?php echo $obj[0][0]['created_at']; ?></span>
            <div style="clear:both;"></div>
            <table class="table" cellspacing="0" border="0">
                ...
                <tbody>
                    ...
                    $count = 1;
                    $qty = 0;
                    $discount = $obj[0][0]['totalDiscount'];
                    $sub_total = $obj[0][0]['subTotal'];
                    $total = $obj[0][0]['totalPrice'];
                    $paid =  $obj[0][0]['paid'];
                    $change = $obj[0][0]['chnge'];
                    $ammount1=0;
                   // $previousBalance = $obj['previousBalance'];
                   ...
                   /*  parse_str($str, $output); */
                    ...
                    foreach ($obj[0] as $key=>$value) {
                        ...
                        <td  style='text-align:center; font-size: 10px; width:50px;'>$quantity</td>
            ...
            <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px;">
                <tbody>
                    <tr>
                        <td style="text-align:left; font-size: 12px;">Total Qty</td><td style="text-align:right; padding-right:1.5%;font-size: 12px; border-right: 1px solid #000"><?php echo  $qty; ?></td>
                        <td style="text-align:left; padding-left:1.5%;font-size: 12px;">Gross Total</td><td style="text-align:right;font-size: 12px;"><?php echo $ammount1; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align:left; border-top:1px solid #000; padding-top:5px;font-size: 12px;"><b>All Sub Total</b></td><td colspan="2" id="tax" style="border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;"><b><?php echo $total+$discount; ?></b></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:left; border-top:1px solid #000; padding-top:5px;font-size: 12px;"><b>Discount </b></td><td colspan="2" id="tax" style="border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;"><b><?php echo $discount; ?></b></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align:left; border-top:1px solid #000; padding-top:5px;font-size: 12px;"><b>All Total</b></td><td colspan="2" id="tax" style="border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;"><b><?php echo $total; ?></b></td>
                    </tr>
                ...
                <!-- <tr><td colspan='2' style='text-align:left; border-top:1px solid #000; padding-top:5px;font-size: 12px;'>Previous Balance</td><td colspan='2' id='previous_bal' style='border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;'><?php //echo $previousBalance; ?></td>
                    ...
                    <!--<tr>
                        <td colspan="2" style="text-align:left;border-top:1px solid #000;  padding-top:5px;font-size: 12px;">Grand Total</td><td colspan="2" id="grand_total" style="border-top:1px solid #000; padding-top:5px; text-align:right;font-size: 12px;"><?php echo $total; ?></td>
                    </tr>-->
                    <tr>
                    ...
                    <tr><td colspan="2" style="text-align:left; padding-top:5px;font-size: 12px;">Balance</td><td colspan="2" style="padding-top:5px; text-align:right;font-size: 12px;"><?php echo $change; ?></td>
                    </tr>
                </tbody>
            </table>
            <?php if(isset($obj[1])){ ?>
                ...
                <table class="table" cellspacing="0" border="0">
                    ...
                    <tbody>
                        ...
                        foreach ($obj[1] as $value) {
                            ...
                            echo "<tr class='spaceUnder'><td  style='text-align:left;width: 377px;font-size: 11px;'><b>$value[name]</b> </td>
                           
                            <td  style='text-align:center; font-size: 10px; width:50px;'><b>$value[qty]</b></td>";
                            $count++;
                        } 
                        ?>
